...
logo_url = "logo.png"  # Ganti dengan URL logo Anda
...
def show_results(accuracy, f1, mean_cv_score, conf_matrix, y_pred, y_actual, repair_status, repair_action):
    # Map predicted labels to failure types
    failure_types = {
        0: 'No Failure',
        1: 'Power Failure',
        2: 'Tool Wear Failure',
    ...
    # Map actual labels to failure types
    ...
    # Show predicted failure, actual failure, repair status, and repair action
...
st.text("""Model klasifikasi dipilih melalui antarmuka pengguna. Setelah model dipilih, model tersebut dilatih dan dievaluasi menggunakan data yang sama. Kemudian, hasil prediksi kegagalan ditampilkan berdasarkan model yang dipilih.""")
